...
<html>
    <head>
        <title>Conectayas &copy; (by Joan Alba Maldonado)</title>
        <!-- (c) Conectayas - Program by Joan Alba Maldonado (granvino@granvino.com). Prohibited to publish, reproduce or modify without maintain author's name. -->
...
//                    if (jugador_actual != "usuario" || document.getElementById("pieza").style.visibility == "hidden" || document.getElementById("pieza_sombra").style.visibility == "hidden") { return; }
                ...
                function mostrar_ocultar_opciones()
                {
                    ...
                    if (document.getElementById("opciones").style.visibility == "visible") { document.getElementById("opciones").style.visibility = "hidden"; document.getElementById("opciones_sombra").style.visibility = "hidden"; document.getElementById("menu").title = "Open options"; if (jugador_actual == "usuario") { document.getElementById("zona_juego_invisible").style.visibility = "visible"; } }
                    //...pero si esta oculto, se muestra:
                    else { document.getElementById("opciones").style.visibility = "visible"; document.getElementById("opciones_sombra").style.visibility = "visible"; document.getElementById("menu").title = "Close options"; document.getElementById("zona_juego_invisible").style.visibility = "hidden"; }
                }
                ...
                function aplicar_opciones()
                {
                    ...
                    if (errores != "")
                    {
                        ...
                        alert("Options can't be apply correcty, because:\n" + errores);
                    ...
                    else
                    {
                        ...
                        if (confirm("Press ok to apply the options. Actual game will be lost."))
                        {
                ...
                function iniciar_juego()
                {
                    ...
                    //if (jugadores == 1) { jugador_actual = "usuario"; }
...
//                            var comienzo_bucle = (fila_comienzo_linea <= 1) ? comienzo_linea : comienzo_linea+tablero_width-1;
                    ...
                    if (ganador != "")
                    {
                        ...
                        if (ganador == "usuario")
                        {
                            ...
                            document.getElementById("pieza_sombra").style.visibility = "hidden";
                            //Da la enhorabuena:
                            if (jugadores == 2) { mostrar_mensaje("Congratulations player "+numero_jugador); alert("Player "+numero_jugador+" won."); }
                            else { mostrar_mensaje("You won"); alert("Congratulations! you won."); }
                            //Deja de mostrar el mensaje:
                            mostrar_mensaje("");
                        }
                        else { mostrar_mensaje("You lost"); alert("You lost."); mostrar_mensaje(""); } //Si gana el ordenador, se notifica.
                    ...
                    else
                    {
                        ...
                        if (!huecos_libres)
                        {
                            mostrar_mensaje("There is no winner");
    ...
    <body onLoad="iniciar_juego_primera_vez();" onMouseMove="arrastrar_pieza(event, true);" onMouseUp="campo_seleccionable = false; document.onmousemove=function(event) { arrastrar_opciones(event, false); }" bgcolor="#ddddef" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <!-- Menu: -->
        <div id="menu" style="left:110px; top:10px; width:65px; height:20px; position:absolute; border:0px; padding:0px; background:transparent; color:#000000; text-align:center; line-height:20px; text-decoration:none; font-family:arial; font-size:12px; cursor:pointer; cursor:hand; -moz-user-select:none; z-index:2;" title="Open options" onMouseOver="this.style.fontWeight = 'bold';" onMouseOut="this.style.fontWeight = 'normal';" onClick="mostrar_ocultar_opciones();" onSelectStart="return false;">
            Options
        </div>
        <div id="juego_nuevo" style="left:8px; top:10px; width:110px; height:20px; position:absolute; border:0px; padding:0px; background:transparent; color:#000000; text-align:center; line-height:20px; text-decoration:none; font-family:arial; font-size:12px; cursor:pointer; cursor:hand; -moz-user-select:none; z-index:2;" title="New game" onMouseOver="this.style.fontWeight = 'bold';" onMouseOut="this.style.fontWeight = 'normal';" onClick="if (se_ha_tirado && confirm('Press ok to start a new game. Actual game will be lost.')) { clearInterval(ficha_cayendo); ficha_cayendo = false; iniciar_juego(); }" onSelectStart="return false;">
            New game
        </div>
        <!-- Fin de Menu. -->
        <!-- Zona de juego: -->
        ...
        <div id="opciones" style="left:40px; top:50px; width:340px; height:480px; visibility:hidden; position:absolute; border:0px; padding:0px; background:#efefdd; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:10px; filter:alpha(opacity=70); opacity:0.7; -moz-opacity:0.7; -khtml-opacity:0.7; cursor:crosshair; z-index:5;" onMouseUp="campo_seleccionable = false; document.onmousemove=function(event) { arrastrar_opciones(event, false); }" onMouseDown="if (campo_seleccionable) { campo_seleccionable = false; document.onmousemove=function(event) { arrastrar_opciones(event, false); } } else { document.onmousemove=function(event) { arrastrar_opciones(event, true); } }">
            <div style="left:312px; top:2px; position:absolute; cursor:pointer; cursor:hand; -moz-user-select:none;" title="Close options" onMouseOver="this.style.fontWeight = 'bold';" onMouseOut="this.style.fontWeight = 'normal';" onClick="mostrar_ocultar_opciones();" onSelectStart="return false;">[x]&nbsp;</div>
                ...
                <form style="display:inline;" onSubmit="aplicar_opciones(); return false;" align="center">
                   <center>
                       <fieldset style="width:280px; cursor:crosshair;">
                           <legend style="width:280px; color:#aa0000; font-size:20px; font-weight:bold; text-align:center; -moz-user-select:none;" onSelectStart="return false;" title="Options menu">Options</legend>
                           <br>
                           <center>
                               <select id="numero_jugadores" name="numero_jugadores" style="cursor:pointer; cursor:hand;" onChange="if (parseInt(this.value) == 2) { document.getElementById('primer_jugador').disabled = true; } else { document.getElementById('primer_jugador').disabled = false; }">
                                   <option value="1">1 Player (user versus computer)</option>
                                   <option value="2">2 Players (user versus user)</option>
                               </select>
                           </center>
                           <br>
                           <label for="tablero_ancho" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="w" title="Board width (number of holes)"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; Board <u>w</u>idth:</b> <input type="text" name="tablero_ancho" id="tablero_ancho" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="4" maxlength="3" style="height:22px; color:#0000aa; background:#ffffdd; font-family:courier; line-height:12px; font-size:12px; font-weight:bold;" accesskey="w"></label>
                           <br>
                           <br>
                           <label for="tablero_alto" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="h" title="Board height (number of holes)"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; Board <u>h</u>eight:</b> <input type="text" name="tablero_alto" id="tablero_alto" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="4" maxlength="3" style="height:22px; color:#0000aa; background:#ffffdd; font-family:courier; line-height:12px; font-size:12px; font-weight:bold;" accesskey="h"></label>
                           <br>
                           <br>
                           <label for="fichas_necesarias" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="n" title="Necessary pieces to put in line to win"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; <u>N</u>ecessary pieces to win:</b> <input type="text" name="fichas_necesarias" id="fichas_necesarias" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="4" maxlength="3" style="height:22px; color:#0000aa; background:#ffffdd; font-family:courier; line-height:12px; font-size:12px; font-weight:bold;" accesskey="n"></label>
                           <br>
                           <br>
                           <label for="color_usuario" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="u" title="Color of user piece (RGB hexadecimal in HTML)"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; Color of <u>u</u>ser:</b> <input type="text" name="color_usuario" id="color_usuario" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="8" maxlength="7" style="height:22px; color:#0000aa; background:#ffffdd; font-family:courier; line-height:12px; font-size:12px; font-weight:bold;" accesskey="u"></label>
                           <br>
                           <br>
                           <label for="color_ordenador" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="o" title="Color of opponent piece (RGB hexadecimal in HTML)"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; Color of <u>o</u>pponent:</b> <input type="text" name="color_ordenador" id="color_ordenador" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="8" maxlength="7" style="height:22px; color:#0000aa; background:#ffffdd; font-family:courier; line-height:12px; font-size:12px; font-weight:bold;" accesskey="o"></label>
                           <br>
                           <br>
                           <label for="gravedad" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="g" title="If gravity is active, pieces will fall"><b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; <input type="checkbox" name="gravedad" id="gravedad" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" accesskey="g" style="cursor:pointer; cursor:hand;"> Activated <u>g</u>ravity</b></label>
                           <br>
                           <br>
                           <label for="primer_jugador" style="line-height:12px; font-size:12px; cursor:pointer; cursor:hand;" accesskey="i" title="Who start the game">
                           <b style="-moz-user-select:none;" onSelectStart="return false;">&nbsp; F<u>i</u>rst player:</b>
                           <select id="primer_jugador" name="primer_jugador" accesskey="i" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" style="cursor:pointer; cursor:hand;">
                               ...
                               <option value="ordenador">computer</option>
                           </select>
                           </label>
                           <br>
                           <br>
                           <center><input type="submit" value="Aplicar" name="boton_aplicar" style="height:24px; color:#aa0000; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:pointer; cursor:hand; -moz-user-select:none;" accesskey="a" onSelectStart="return false;" title="Apply options"></center>
                           <br>
                       </fieldset>
                    </center>
                </form>
        ...
        <div id="informacion" style="left:10px; top:490px; height:0px; position:absolute; border:0px; padding:0px; background:transparent; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:10px; z-index:3;">
            &copy; <b>Conectayas</b> 0.17a by <i>Joan Alba Maldonado</i> (<a href="mailto:granvino@granvino.com">granvino@granvino.com</a>) &nbsp;<sup>(DHTML 100%)</sup>
